...
# -*- coding: latin-1 -*-
        ...
        ### # Begin Email/SMS Script Info
        # Provides:          Real Time Notification
        # Required-Start:    Sensors/Cameras trigger
        # Required-Stop:     Correct Authontication
        # Default-Start:     none
        # Default-Stop:      After Sending Immediately
        # Short-Description: Email ALert
...
#readin values from the file and put it on the right place
#reading destination email
#dest_eamil= theHome_owner.email
...
attachment = open("./email_config.txt", "rb")
